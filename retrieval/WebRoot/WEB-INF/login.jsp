...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/" method="post">
		<label class="input-label" for="username">登录名</label>
		<input type="text" id="username" name="user.username" class="input-block-level required" value="${user.username}">
		<label class="input-label" for="password">密码</label>
		<input type="password" id="password" name="user.password" class="input-block-level required">
