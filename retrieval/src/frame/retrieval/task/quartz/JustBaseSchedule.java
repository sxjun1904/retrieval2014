...
public class JustBaseSchedule implements java.io.Serializable,Cloneable {
	private static final long serialVersionUID = 1L;
	public static final String SCHEDULE_SECONDS = "s";
	public static final String SCHEDULE_MINUTES = "m";
	public static final String SCHEDULE_HOURS = "h";
	/**
	 * 调度guid
	 */
