...
public class QueryItem implements Serializable{
	 ...
	 * @return
	 */
	public QueryItem range(long start,long end,String field){
	    return range(start,end,field,QueryItem.MUST);
	}
	 ...
	 * @return
	 */
	public QueryItem range(long start,long end,String field,BooleanClause.Occur occur){
	    // 采用NumericRangeQuery对时间范围进行检索
	    NumericRangeQuery<Long> rangeQuery = NumericRangeQuery.newLongRange(field, start, end,true, true);
	    
	    BooleanQuery query=new BooleanQuery();
		query.add(this.query,occur);
		query.add(rangeQuery, QueryItem.MUST);
		this.query=query;
		return this;
	}
