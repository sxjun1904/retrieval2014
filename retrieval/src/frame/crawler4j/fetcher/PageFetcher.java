...
package frame.crawler4j.fetcher;
...
import frame.crawler4j.crawler.Configurable;
...
public class PageFetcher extends Configurable
{
	...
	public PageFetcher(CrawlConfig config)
	{
		...
		if (config.getProxyHost() != null)
		{
			...
			{
				httpClient.getCredentialsProvider().setCredentials(new AuthScope(config.getProxyHost(), config.getProxyPort()),
	...
	public PageFetchResult fetchHeader(WebURL webUrl)
	{
		...
		{
			logger.error("Fatal transport error: " + e.getMessage() + " while fetching " + toFetchURL + " (link found in doc #"
