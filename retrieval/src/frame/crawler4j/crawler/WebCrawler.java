...
import frame.crawler4j.fetcher.CustomFetchStatus;
import frame.crawler4j.fetcher.PageFetchResult;
...
import frame.crawler4j.parser.ParseData;
import frame.crawler4j.parser.Parser;
...
public class WebCrawler implements Runnable
{
	...
	/**
	 * The controller instance that has created this crawler thread. This reference to the controller can be used for getting configurations of the
	...
	/**
	 * The RobotstxtServer instance that is used by this crawler instance to determine whether the crawler is allowed to crawl the content of each
	 * page.
	 */
	...
	/**
	 * Is the current crawler instance waiting for new URLs? This field is mainly used by the controller to detect whether all of the crawler
	 * instances are waiting for new URLs and therefore there is no more work and crawling can be stopped.
	 */
	...
	/**
	 * This function is called just before starting the crawl by this crawler instance. It can be used for setting up the data structures or
	...
	/**
	 * This function is called just before the termination of the current crawler instance. It can be used for persisting in-memory data or other
	 * finalization tasks.
	 */
	...
	/**
	 * This function is called once the header of a page is fetched. It can be overwritten by sub-classes to perform custom logic for different status
	 ...
	 * Classes that extend WebCrawler can override this function to pass their local data to their controller. The controller then puts these local
	...
	/**
	 * Classes that extends WebCrawler can overwrite this function to tell the crawler whether the given url should be crawled or not. The following
	 * implementation indicates that all urls should be included in the crawl.
	 * 
	 * @param url
	 *            the url which we are interested to know whether it should be included in the crawl or not.
